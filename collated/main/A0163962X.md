...
```
###### \java\project\taskcrusher\logic\commands\SwitchCommand.java
``` java
...
```
###### \java\project\taskcrusher\logic\parser\SwitchCommandParser.java
``` java
...
```
###### \java\project\taskcrusher\model\shared\DateUtil.java
``` java
/**
