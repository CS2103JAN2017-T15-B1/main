    ...
    public static Task[] getSampleTasks() {
        try {
            return new Task[] {
                ...
                new Task(new Name("Watch Harry Potter series"), new Deadline("2017-05-21"), new Priority("1"),
                ...
                new Task(new Name("Physics hw"), new Deadline("2017-06-01 3pm"), new Priority("3"),
                        new Description("Kinematics"), new UniqueTagList("school")),
                new Task(new Name("Chemistry lab"), new Deadline("next Monday"), new Priority("3"),
                ...
                new Task(new Name("Masters application"), new Deadline("next Sunday noon"), new Priority("3"),
